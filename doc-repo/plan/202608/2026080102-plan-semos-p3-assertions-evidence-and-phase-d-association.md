...
> **2026-08-01 status:** Chunks 0–D are complete and live-validated against real Postgres, including real gold-corpus data — see the P3 implementation log `2026080103-devdoc-semos-p3-implementation-log.md`. Chunk E, chunk F, and Track B (keyword lexicon) are not started; this plan document is left as originally written (per the P2 precedent) rather than retroactively checkbox-edited.
