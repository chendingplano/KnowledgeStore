...
Items 1–4 establish trustworthy warm data. Items 5–8 establish generic serving and growth. Items 9–12 connect the metrics pilot and governed-term layer without contaminating the generic modules. Resource import and reconciliation are no longer optional follow-ups: without them, the system can look up a dictionary but cannot build or sustain one.
